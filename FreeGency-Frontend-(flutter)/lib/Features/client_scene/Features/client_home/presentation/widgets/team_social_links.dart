...
class TeamSocialLinks extends StatelessWidget {
  final TeamsModel team;

  const TeamSocialLinks({super.key, required this.team});

  @override
  Widget build(BuildContext context) {
    final socialLinks = team.socialMediaLinks ?? [];
  ...
  String _extractWebsiteName(String url) {
    try {
      ...
      if (parts.length > 1) {
        // Use the capitalize method from the StringExtension in TeamsModel
